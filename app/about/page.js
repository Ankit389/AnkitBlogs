...
//                 <img src="/3.png" alt="Ankit as a beginner" className="w-full rounded-lg shadow-lg" />
//               </div>
...
//               <div className="md:w-1/3">
//                 <img src="/c++coding.png" alt="Ankit learning new skills" className="w-full rounded-lg shadow-lg" />
//               </div>
...
//             <div className="flex flex-col md:flex-row items-center">
//               <div className="md:w-1/3">
//                 <img src="/net.png" alt="Ankit working on a big project" className="w-full rounded-lg shadow-lg" />
//               </div>
//               <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
//                 <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 dark:text-white">
...
//             <div className="flex flex-col md:flex-row-reverse items-center">
//               <div className="md:w-1/3">
//                 <img src="/tow.png" alt="Ankit mentoring others" className="w-80 h-80 rounded-lg shadow-lg" />
//               </div>
//               <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
//                 <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 dark:text-white">
//                   Giving Back
...
//             <div className="flex flex-col md:flex-row items-center">
//               <div className="md:w-1/3">
//                 <img src="/holi.png" alt="Ankit celebrating Holi" className="w-full rounded-lg shadow-lg" />
//               </div>
//               <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
//                 <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 dark:text-white">
