        ...
        <div className="flex-1 flex items-center justify-center p-10 lg:p-20 text-center">
          <div>
            <h1 className="text-6xl lg:text-7xl font-bold text-white leading-tight">
              Payments <span className="block">infrastructure</span> for the <span className="block">internet</span>
            </h1>
    ...
    <div className="flex flex-wrap justify-center">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
          <img src="/javascript.png" className="w-full h-64 object-cover rounded-t-lg"/>
          <div className="mt-4">
